...
<div class="row mt-5 mb-5">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="float-right">
            <a class="btn btn-secondary" href="{{ url('kelass/index') }}"> Back</a>
        </div>
    </div>
</div>
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" style="height:150px" name="kompetensi_keahlian" placeholder="kompetensi_keahlian"></textarea>
            </div>
        </div>
